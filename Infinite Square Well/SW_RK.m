...
% in a Infinite Square Well Potential
...
Psi_ini=SW_ti(x,n,a).*SW_td(0, n, a, m, hbar);
%
Psi_old=Psi_ini;
...
filename=strcat('RK_SW_n_',num2str(n),'_tend_',num2str(t_end),'_N_',num2str(N),'_dx_',num2str(dx),'_dt_',num2str(dt));
